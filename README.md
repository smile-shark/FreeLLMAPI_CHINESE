...
基于 [tashfeenahmed/freellmapi](https://github.com/tashfeenahmed/freellmapi)（MIT 协议），全界面翻译为中文，适配中国大陆网络环境（Clash 代理）。
...
> **本仓库是 [tashfeenahmed/freellmapi](https://github.com/tashfeenahmed/freellmapi) 的中文汉化分支。**
> 以下为上游原版 README（仅作展示，版权归原作者所有）。
